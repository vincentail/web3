...
contract UniswapConfig {
    ...
    uint256 public constant maxTokens = 30;
        ...
        if (i == 6)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed06
                });
        if (i == 7)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed07
                });
        if (i == 8)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed08
                });
        if (i == 9)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed09
                });
        ...
        if (i == 10)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed10
                });
        if (i == 11)
            return
                TokenConfig({
        ...
        if (i == 12)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed12
                });
        if (i == 13)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed13
                });
        if (i == 14)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed14
                });
        if (i == 15)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed15
                });
        if (i == 16)
            return
                TokenConfig({
        ...
        if (i == 17)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed17
                });
        if (i == 18)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed18
                });
        if (i == 19)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed19
                });
        ...
        if (i == 20)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed20
                });
        if (i == 21)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed21
                });
        if (i == 22)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed22
                });
        if (i == 23)
            return
                TokenConfig({
        ...
        if (i == 24)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed24
                });
        if (i == 25)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed25
                });
        if (i == 26)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed26
                });
        if (i == 27)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed27
                });
        if (i == 28)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed28
                });
        if (i == 29)
            return
                TokenConfig({
                    ...
                    isUniswapReversed: isUniswapReversed29
                });
    }
...
contract UniswapAnchoredView is UniswapConfig {
        ...
        returns (uint256)
    {
        ...
        if (config.priceSource == PriceSource.FIXED_ETH) {
            uint256 usdPerEth = prices[ethHash];
            require(
                usdPerEth > 0,
    ...
    function postPriceInternal(string memory symbol, uint256 ethPrice)
        internal
    {
        TokenConfig memory config = getTokenConfigBySymbol(symbol);
        require(
        ...
        )
    {
        ...
        return (
            cumulativePrice,
            oldObservations[symbolHash].acc,
            oldObservations[symbolHash].timestamp
        );
    }
